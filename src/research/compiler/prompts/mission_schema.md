...
```json
{
  ...
  "main_agent": {
    ...
    "system_prompt": "string — 2-4 paragraph detailed system prompt",
...
5. input_bindings for tasks with dependencies MUST reference valid (source_task_id, source_key) pairs.
6. workspace_suffix values MUST be unique within a single task's compiled_subagents list.
